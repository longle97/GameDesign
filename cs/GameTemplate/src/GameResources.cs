...
namespace MyGame
{
    public static class GameResources
    {
        ...
        private static void ShowMessage(string message, int number)
        {
            ...
            toDraw.Width = TW;
            toDraw.Height = TH;
            //SwinGame.DrawTextLines(message, Color.White, Color.Transparent, _LoadingFont, FontAlignment.AlignCenter, toDraw); // from VB
            SwinGame.DrawText(message, Color.White, Color.Transparent, _LoadingFont, FontAlignment.AlignCenter, toDraw); // replaces above line, for cs?
        ...
        {
            Bitmap obj;
            foreach (var ob in _Images.Values)
                SwinGame.FreeBitmap(ob);
        }

        private static void FreeSounds()
        {
            SoundEffect obj;
            foreach (var ob in _Sounds.Values)
                Audio.FreeSoundEffect(ob);
        }
